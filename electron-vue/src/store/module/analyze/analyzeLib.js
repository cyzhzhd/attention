...
async function getVideoSrc(videoSrc) {
    video = videoSrc;
    // console.log(video);
    await detectorModel.loadFromUri("https://be.swm183.com:3000/download/detector/model.json");
    await landmarkModel.loadFromUri("https://be.swm183.com:3000/download/landmark/model.json");
