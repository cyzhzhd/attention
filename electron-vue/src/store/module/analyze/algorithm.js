...
function analyzeFaceExpression(landmarks, timestamp) {
  ...
  if (eyeVar.avgEAR > eyeVar.maxEAR) eyeVar.weight = 0.1;
    ...
    eyeVar.weight =
      1 +
      Math.pow(Math.abs(eyeVar.avgEAR), 2) -
      20 * Math.pow(angleVar.pitch, 2);
  if (angleVar.pitch < 0 || angleVar.pitch > 0.18) eyeVar.weight = 0.1;
  eyeVar.closedRatio = (
    (eyeVar.weight * Math.abs(studentData.eyeSize - eyeVar.avgEAR)) /
...
function pointCal(timestamp) {
  ...
  if (pointVar.eyeRatio < 0.15) pointVar.eyeW = 0;
    ...
    pointVar.eyeW = 6.67 * (pointVar.eyeRatio - 0.27) + 0.8;
  else if (pointVar.eyeRatio < 0.34) pointVar.eyeW = 0.8;
  else if (pointVar.eyeRatio < 0.4)
    pointVar.eyeW = 3.34 * (pointVar.eyeRatio - 0.4) + 1;
  ...
  pointVar.arrPoint.push(
    ((pointVar.eyeW * 2.5 + pointVar.deltaW * 1 + pointVar.mouseWw * 6.5) *
      100) /
      10,
  );
  pointVar.tempPoint =
